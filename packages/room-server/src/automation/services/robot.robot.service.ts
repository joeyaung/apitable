...
export class RobotRobotService {
   ...
   */
  public async getRobotById(robotId: string): Promise<IRobot> {
    const trigger = await this.automationTriggerRepository.selectTriggerInfoByRobotId(robotId);
